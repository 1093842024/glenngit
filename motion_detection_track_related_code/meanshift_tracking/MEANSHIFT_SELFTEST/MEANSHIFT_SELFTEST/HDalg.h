...
#define DETECTWITH 0.1  //初始探测忽略的边缘宽度比例
#define LOWGOALTIME 5   //连续两帧评分的差值跟丢阈值
//#define SHOWPRINT
...
*  @note
**/
HumanDetHandle CreateBackModel(bool use_tracking = true,int histnum=8,float gamma=0.5,float scale_factor=0.1);
...
*  @note  
*/
int UpdateAndHD(HumanDetHandle phdHandle,const unsigned char* gray, const int width, const int height, const int step, unsigned int sensitive,unsigned char* colorimg/*, ReturnObjs *out_objs*/);
